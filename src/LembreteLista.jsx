const LembreteLista = (props) => (
    <div
        className="d-flex mb-2 mt-2 w-auto"
        style={{ backgroundColor: '#9d0208', color: '#ffffffff', borderRadius: 8 }}>
        ...
        <div className="  w-30 ms-2 me-4 d-flex justify-content-right align-items-center">
            <i
                className={props.favorito ? "fa-solid fa-star me-2" : "fa-regular fa-star me-2"}
                style={{ color: '#ffc300', cursor: 'pointer' }}
                onClick={props.favoritar}></i>
            <i
                className="fa-solid fa-trash"
                style={{ color: 'write', cursor: 'pointer' }}
